	...
	const projects = [
		{
			...
			description1: "The goal is there are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.",
			description2: "There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.",
			story: "There are many variations of passages...",
			approach: "Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.",
			image1: portfolio1,
		...
		},
		{
			id: 2,
			title: "DesignX",
			shortDesc: "They are was greater open above shelter lets itself under appear sixth open gathering made upon can't own above midst gathering gathered he one us saying can't divide.",
			category: "UI/UX",
			client: "MockStudio",
	...
	return (
		<div>
			<div className="site-content">
				...
				<section id="freelancer-main" className="ceo-content">
					<div className="freelancer-main-wrap">
						...
						<div className="profile-content position-relative container">
							<div className="profile-sec text-center ">
								<div className="profile-img">
									<img className="oval-frame" src={profileImg} alt="profile-img" />
								</div>
								<div className="profile-name">
									<h1 className="mt-10">Katy Anderson</h1>
									<p className="mt-5">Developer</p>
									<p className="profile-title mt-30">A web developer is a professional who specializes in designing and building websites. Their primary responsibility is to create and maintain the structure, layout, and features of a website. Web developers can be broadly categorized into front-end deve.</p>
								</div>
							</div>
								...
								<Slider {...services}>
									<div className="services-content">
										...
										<div className="sercices-details mt-15">
											...
											<p className="mt-5">Id pellentesque sed eu sollicitudin. Ac turpis scelerisque nec dignissim sit potenti integer at eget. Urna felis nisl ornare in fermentum orci dictum. Viverra amet nunc senectus mauris leo diam massa orci. Nam lacinia.</p>
										</div>
									</div>
									<div className="services-content">
										<div className="sercices-img text-center">
						...
						<div className="product-sec">
							...
							<div className="product-bottom-sec mt-10 container ps-0" data-cursor-text="DRAG" data-cursor="sm">
								<Slider {...product}>
									{products.map((product) => (
										<div className="product-content mlr-auto mt-15" key={product.id} onClick={() => handleBuyNow(product)}>
						...
						<div className="portfolio-sec">
							<div className="portfolio-sec-wrap" data-cursor-text="Click" data-cursor="sm">
								<div className="services-top">
									<h2>My Portfolio</h2>
								</div>
								...
								<div className="container">
									...
									<div className="testimonial-sec-bottom">
										<div id="testimonial-slider" className="carousel slide" data-bs-ride="carousel">
											<div className="carousel-inner">
												<div className="carousel-item active">
													<div className="testimonial-content">
														...
														<p className="testimonial-para mt-10">Lobortis etiam lectus mollis vulputate non egestas. Non aliquet facilisis leo tellus vulputate malesuada et tellus. Maecenas arcu non ultrices non est lorem at risus. Imperdiet vulputate feugiat morbi faucibus vulputate fermentum blandit faucibus vitae.</p>
											...
											<button className="carousel-control-prev" type="button" data-bs-target="#testimonial-slider" data-bs-slide="prev">
												<span className="carousel-control-prev-icon" aria-hidden="true"></span>
												<span className="visually-hidden">Previous</span>
											</button>
											<button className="carousel-control-next" type="button" data-bs-target="#testimonial-slider" data-bs-slide="next">
										...
										<div className="appointment-bottom-wrap">
											<form className="appointment-form">
												<div className="appointment-date mt-15">
													<div>
														<label className="info-person" htmlFor="datepicker">DATE</label>
													</div>
													<div className="input-wrapper">
														<span><img src={dateIcon} alt="date-icon-icon" className="purple-filter " /></span>
														<DatePicker
															id="datepicker"
												...
												<div className="appointment-date mt-15">
													<div>
														<label className="info-person" htmlFor="datepicker">TIME</label>
													</div>
													<div className="date-list">
														<div className="appointment-date-list">
															<span><img src={timeIcon} alt="date-icon-icon" className="purple-filter" /></span>
						...
						<div className="inquiry-sec ">
							<div className="inquiry-sec-wrap container">
								...
								<form className="inquiry-form">
									<div>
										<label className="info-person mt-15" htmlFor="username">Your Name</label>
										<div className="input-wrapper-form mt-5">
											<span className="icon">
												<img src={personIcon} alt="person-icon" className="purple-filter" />
											</span>
											<input type="text" id="username" placeholder="Your Name" autoComplete="off" />
										</div>
									</div>
									<div>
										<label className="info-person mt-15" htmlFor="phone-number">Enter Phone Number</label>
										<div className="input-wrapper-form mt-5">
											<span className="icon">
												<img src={callIcon} alt="person-icon" className="purple-filter" />
											</span>
											<input type="number" id="phone-number" placeholder="Your Phone Number" autoComplete="off" />
										</div>
									</div>
									<div>
										<label className="info-person mt-15" htmlFor="email">Email Address</label>
										<div className="input-wrapper-form mt-5">
											<span className="icon">
												<img src={mailIcon} alt="person-icon" className="purple-filter" />
											</span>
											<input type="text" id="email" placeholder="Your Email Address" autoComplete="off" />
										</div>
									</div>
									<div>
										<label className="info-person mt-15" htmlFor="email">your message</label>
										<div className="input-wrapper-form textarea-txt mt-5">
											<textarea rows="4" cols="50" placeholder="Type a message here..." className="custom-textarea border-0" id="textarea"></textarea>
										</div>
									</div>
									<div className="view-product mt-20">
								...
								<div className="contact-bottom-sec">
									...
									<div className="contact-details mt-10">
										...
										<div className="contact-content">
											...
											<p className="mt-10">121 Parkview Street, ST Nova, New York</p>
										</div>
									</div>
									<div className="contact-details mt-10">
										<div className="contact-icon">
						...
						<div className="map-sec container mt-30">
							<div className="map-img">
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5972.947970483601!2d-74.11083001911878!3d41.53733348863559!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89dd2ec0808761b3%3A0x4c7e057168f91e51!2s121%20Parkview%20St%2C%20Newburgh%2C%20NY%2012550%2C%20USA!5e0!3m2!1sen!2sin!4v1726220356539!5m2!1sen!2sin" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="map"></iframe>
							</div>
						</div>
						<div className="add-to-contact container">
							<div className="add-to-contact-wrap">
								<Link to="#" className="scan-btn" data-bs-toggle="modal" data-bs-target="#product-modal-scan">
									<img src={scanIcon} alt="scan-icon" />
								</Link>
								<Link to="#" className="scan-btn" data-bs-toggle="modal"
								...
								<a href="tel:+12345678900" className="add-to-btn">
									<div className="add-to-btn-sec">
										...
										<div className="plus-btn"><img src={bPlusIcon} alt="plus-icon" /></div>
									</div>
								</a>
							</div>
						</div>
				...
				{/* <!--  Scan modal start --> */}
				<div className="modal fade" id="product-modal-scan" tabIndex="-1" aria-hidden="true">
						...
						<div className="modal-content">
							...
							<div className="modal-body">
								...
								<div className="qr-btn mt-30">
									<div className="btn1">
										<Link to="#" onClick={downloadImage}>Download</Link>
									</div>
									<div className="btn1">
										<Link to="#" onClick={shareImage}>Share</Link>
									</div>
								</div>
							</div>
						</div>
				...
				{/* <!--  Scan modal end --> */}
				{/* <!--  Share modal start --> */}
				<div className="modal fade" id="share-media-modal" tabIndex="-1" aria-hidden="true">
					<div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
						<div className="modal-content">
							<div className="modal-header">
							...
							<div className="modal-body">
								<div className="social-media-content">
									...
									<div className="social-media-img">
										<a href="https://analytics.pinterest.com/login/" target="_blank" rel="noreferrer">
											<img src={icon10} alt="social-icon" />
										</a>
									</div>
									<div className="social-media-img">
										<a href="mailto:jordan.smith@mail.com" target="_blank" rel="noreferrer">
